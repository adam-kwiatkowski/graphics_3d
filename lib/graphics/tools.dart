...
import 'package:graphics_3d/graphics/shapes/rectangle.dart';
...
class PaintBucketTool extends Tool {
  PaintBucketTool() : super('Paint Bucket', Icons.format_color_fill_outlined);

  @override
  void onTapDown(Offset offset, Drawing drawing) {
    drawing.floodFill(offset, drawing.color);
  }
}
